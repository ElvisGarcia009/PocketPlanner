...
class _ItemRaw {
  ...
  Future<void> _syncWithFirebaseIncremental(
    ...
    // Fetch remotos
    final remoteSecIds = (await secColl.get())
      .docs.map((d) => d.id).toSet();
    final remoteItmIds = (await itmColl.get())
      .docs.map((d) => d.id).toSet();
